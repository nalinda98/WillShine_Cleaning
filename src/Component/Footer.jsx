    ...
    <div>
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="footer-box-layout1">
                  ...
                  <ul className="footer-menu-list">
                    ...
                    <li><a href="#">Vehicle Wash</a></li>
                    <li><a href="#">Laundry Facilities</a></li>
                    <li><a href="#">Carpet Removal</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="footer-box-layout1">
                  ...
                  <ul className="footer-menu-list">
                    ...
                    <li><a href="#">Cloud Affiliate Program</a></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="copyright">
                  ...
                  <a href="https://buildzoneit.com/" style={{ color: "white", fontWeight: "bold" }}> BuildZone IT</a>
                </div>
              </div>
              <div className="col-md-6">
                <div className="footer-bottom-menu">
                  <ul>
                    <li><button className="btn btn-link p-0" onClick={handleShow}>Privacy Policy</button></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <Modal show={showModal} onHide={handleClose} size="lg" scrollable>
        ...
        <Modal.Body style={{ whiteSpace: "pre-wrap" }}>
          ...
          {"\n"}Suggested text: Our website address is: https://blossompropertyservices.com.au.
